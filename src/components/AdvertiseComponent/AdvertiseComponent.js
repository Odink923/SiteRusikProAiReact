...
const closeModal2 = () => setIsModalOpen2(false);
  return (
    ...
    <ShadowCard
      ...
      1 червня відбудеться великий дитячий захід, присвячений Міжнародному дню захисту дітей. У цей день маленькі гості зможуть поринути в атмосферу свята, яке наповнене радістю та веселощами. Ярмарка, виступи талановитих дітей, майстер-класи для творчості — все це стане частиною незабутнього дня. Для маленьких відвідувачів будуть солодка вата, подарунки та цікаві акції. Кожен зможе взяти участь у веселих активностях, що принесуть масу емоцій і радісних моментів. Це свято не тільки для дітей, а й для дорослих, адже разом ми створимо атмосферу тепла, любові та взаємної підтримки. Запрошуємо всіх приєднатися до цього великого святкування дитячих мрій і захисту прав малечі!<br/>
      <br/>
Дата: 1 червня <br/>
...
Адреса: алея Дарницького ринку, вздовж сімейного магазину "UMKA.SHOP", вулиця Ісмаїла Гаспринського, 15Б, Київ
        ...
        <br/>
"Краща версія себе" — це простір, де ви зможете зануритися у світ арт-терапії, тілесних практик, трансформаційних ігор та емоційного відновлення.  <br/>
<br/>
Що на вас чекає?  <br/>
🔸 Майстер-класи з психології та арт-терапії  <br/>
🔸 Sound-healing сесії  <br/>
🔸 Тілесні практики  <br/>
🔸 Лекції від експертів  <br/>
...
Придбати квитки - https://secure.wayforpay.com/payment/thebestverion
        ...
        <br/>
Конференція також включає в себе мережеві сесії, творчу та концертну програму, а також кава-брейки для неформального спілкування. Захід проходитиме у закритому VIP-форматі, доступ можливий лише за запрошеннями, тож для участі необхідно попередньо заповнити анкету.<br/>
<br/>
